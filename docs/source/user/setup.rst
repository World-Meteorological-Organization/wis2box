...
Download ``wis2box-setup-1.3.0.zip`` from the `wis2box release page`_ page and unzip using the following commands:
...
Select ``y`` and the the script will create the file ``docker-compose.images-1.3.0.yml`` file, download the required Docker images and start the services.
...
.. _`wis2box release page`: https://github.com/World-Meteorological-Organization/wis2box-release/releases/tag/1.3.0
