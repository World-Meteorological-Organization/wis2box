...
`IBL Moving Weather <https://www.iblsoft.com/products/moving-weather/>`_ is a commercial solution providing an automated meteorological switching system used for the routine distribution of meteorological messages as well
...
Configuring IBL MW to send data into wis2box SFTP
-------------------------------------------------
...
.. image:: ../../_static/IBL-MW-file-properties.png
    :width: 1000
    :alt: IBL MW file properties configuration example
...
Assuming the wis2box-instance and IBL MW are hosted on the same network can you provide an internal IP of the wis2box-host as the host name.
...
.. image:: ../../_static/IBL-MW-sftp-configuration-example.png
    :width: 1000
    :alt: IBL MW SFTP configuration example
