...
It is developed using open-source technologies and is distributed under the GPLv3 license, making it freely available.
...
Note, both export and connector specifications need to be enabled for automatic export of data to WIS2BOX to happen.
